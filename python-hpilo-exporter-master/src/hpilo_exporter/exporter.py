      ...
      #  ilo_host = "https://192.168.2.130"
       ...
       #     ilo_user = query_components['ilo_user'][0]
        ...
        if url.path == self.server.endpoint and ilo_host and ilo_user and ilo_password:
            ...
            systems = redfishobj.search_for_type("ComputerSystem.") # return json file
            system_rsp = {}
	    ...
	    #system_rsp = system_rsp.dict
            ...
            BiosVersion = system_rsp.dict['BiosVersion'] # system.json (1)
            ServerModel = system_rsp.dict['Manufacturer'] + ' ' + system_rsp.dict['Model'] # 1
            PowerState = system_rsp.dict['PowerState'] # 1
